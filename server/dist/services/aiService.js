...
exports.generateAssistantAnswer = generateAssistantAnswer;
...
async function callGeminiChat(systemText, userText, model = GEMINI_MODEL) {
    if (!GEMINI_API_KEY)
...
async function generateAssistantAnswer(params) {
...
async function callOpenRouterChat(messages, model = OPENROUTER_MODEL) {
    if (!OPENROUTER_API_KEY)
