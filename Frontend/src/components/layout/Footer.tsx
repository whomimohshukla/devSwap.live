...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: Github, href: 'https://github.com/devswap-live' },
    { name: 'Twitter', icon: Twitter, href: 'https://twitter.com/devswaplive' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/devswap-live' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              The premier platform for developers and engineers to exchange skills, 
              learn from each other, and grow together through real-time collaboration.
            </p>
