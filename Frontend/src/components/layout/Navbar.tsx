										...
										<div className='flex items-center space-x-2'>
											...
											<span className='relative inline-flex items-center'>
												...
												{link.path === "/matches" && searching && (
													<span className='ml-2 inline-flex items-center rounded-full bg-emerald-700/40 text-emerald-300 text-[10px] px-2 py-0.5'>
														Searching
													</span>
												)}
											</span>
								...
								<div className='relative'>
									...
									{isNotifOpen && (
										<div className='absolute right-0 mt-2 w-80 bg-[#0b0c0d] border border-[#25282c] rounded-xl shadow-xl overflow-hidden z-50'>
											<div className='px-4 py-2 border-b border-[#25282c] text-white/80 text-sm'>
												Notifications
											</div>
											<div className='max-h-80 overflow-y-auto'>
												{notifications.length === 0 ? (
													...
													notifications.map((n) => (
														<div
															key={n.id}
															className='px-4 py-3 border-b border-[#25282c] last:border-b-0'
														>
