  ...
  const features = [
    {
      ...
      description: 'Personalized lesson plans powered by OpenAI to accelerate your learning path.',
    },
    {
      icon: Video,
      title: 'Real-time Sessions',
      description: 'WebRTC + Socket.io for low-latency audio/video and live collaboration.',
    },
    {
      icon: Code2,
      title: 'Code Sync',
      description: 'Collaborative code editing and sharing with instant synchronization.',
    },
    {
      icon: Network,
      title: 'Smart Matching',
      description: 'Redis-backed matching pairs you with complementary skills and availability.',
    },
    {
      icon: MessageSquare,
      title: 'Chat & Signals',
      description: 'In-session chat and WebRTC signaling for seamless connection setup.',
    },
    {
      icon: Shield,
      title: 'Secure Sessions',
      description: 'Auth, verified profiles, and session controls for safe learning.',
    },
  ];
  ...
  const testimonials = [
    {
      ...
      company: 'Google',
      content: 'DevSwap helped me learn React Native by teaching Python. The skill exchange model is brilliant!',
      avatar: 'SC',
    },
    {
      name: 'Marcus Johnson',
      ...
      company: 'Microsoft',
      content: 'Found amazing mentors and mentees. The real-time collaboration features are top-notch.',
      avatar: 'MJ',
    },
    {
      ...
      company: 'Spotify',
      content: 'The AI matching is incredibly accurate. I\'ve learned more in 3 months than in years of solo study.',
      avatar: 'ER',
    },
  ];
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/80 mb-8">
                The revolutionary platform where developers exchange skills in real-time. 
                Master new technologies while sharing your expertise with others.
              </p>
            </motion.div>
      ...
      <section className="py-20 bg-[#0b0c0d]">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">The DevSwap Platform Engine</h2>
            <p className="text-lg text-white/80">Powered by microservices: Auth, Sessions, AI, Realtime, Matching, and Users</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Authentication', desc: 'Secure auth, profiles, and session controls.', api: '/api/auth/*' },
              { title: 'Sessions', desc: 'Create, join, and manage skill-swap sessions.', api: '/api/sessions/*' },
              { title: 'AI Services', desc: 'Lesson plans and summaries with caching.', api: '/api/ai/*' },
              { title: 'Realtime Signaling', desc: 'WebRTC signaling, chat, and presence.', api: '/api/signaling/*' },
              { title: 'Matching', desc: 'Redis-based skill matching and availability.', api: '/api/match/*' },
              { title: 'Users', desc: 'User management and skill profiles.', api: '/api/users/*' },
            ].map((item, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <span className="inline-block text-xs px-2 py-1 rounded bg-[#00ef68]/10 border border-[#00ef68]/20 text-[#00ef68]">{item.api}</span>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="space-y-6">
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-white font-semibold">AI Lesson Plans</h3>
                </div>
                <p className="text-white/80 text-sm leading-relaxed">
                  Generate personalized lesson plans with <span className="text-[#00ef68]">/api/ai/lesson-plan</span>.
                  Plans are cached for speed and updated as you progress.
                </p>
              </motion.div>
              <motion.div
                whileHover={{ y: -4 }}
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-white font-semibold">Realtime Sessions</h3>
                </div>
                <p className="text-white/80 text-sm leading-relaxed">
                  WebRTC media, Socket.io signaling, and collaborative editing — all optimized for low latency.
                </p>
              </motion.div>
              <motion.div
                whileHover={{ y: -4 }}
              ...
              >
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-white font-semibold">Auto Session Summaries</h3>
                </div>
                <p className="text-white/80 text-sm leading-relaxed">
                  After each session, receive an AI-generated recap via <span className="text-[#00ef68]">/api/ai/summary</span> with resources and next steps.
                </p>
              </motion.div>
            </div>
            ...
            <div className="p-6 bg-[#25282c] rounded-xl border border-[#25282c]">
              <h3 className="text-white font-semibold mb-4">Sample Learning Summary</h3>
...
- WebRTC samples on GitHub`}
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <span className="px-2 py-1 text-xs rounded bg-[#00ef68]/10 text-[#00ef68] border border-[#00ef68]/20">/api/ai/summary</span>
                <span className="px-2 py-1 text-xs rounded bg-[#00ef68]/10 text-[#00ef68] border border-[#00ef68]/20">WebRTC</span>
                <span className="px-2 py-1 text-xs rounded bg-[#00ef68]/10 text-[#00ef68] border border-[#00ef68]/20">Socket.io</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80">
              From AI lesson plans to real-time sessions — everything you need to learn and mentor effectively
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'List the skills you can teach and what you want to learn. Our AI analyzes your expertise level.',
              },
              {
                step: '02',
                title: 'Get Matched',
                description: 'Our smart algorithm finds the perfect learning partners based on complementary skills and schedules.',
              },
              {
                step: '03',
                title: 'Start Learning',
                description: 'Join live sessions with screen sharing, code collaboration, and real-time communication.',
              },
            ].map((step, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-[#25282c]">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/80">
              See what our community has to say about their DevSwap experience
            </p>
          </div>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex mt-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 text-[#00ef68] fill-current" />
                  ))}
                </div>
              </motion.div>
            ))}
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="relative text-lg md:text-xl text-white/80 mb-8">
              Pair up with developers to teach what you know and learn what you need through guided sessions.
            </p>
