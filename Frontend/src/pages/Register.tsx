      ...
      <div className="px-6 sm:px-8 lg:px-12 py-16">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-white text-[#0b0c0d] text-xs font-bold">G</span>
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Name Field */}
              <div>
                <label htmlFor="name" className="block text-sm font-medium label mb-2">
                  Full Name
                </label>
                <div className="relative">
                ...
                {errors.name && (
                  <p className="mt-1 text-sm text-white/80">{errors.name.message}</p>
                )}
              </div>

              {/* Email Field */}
              <div>
                <label htmlFor="email" className="block text-sm font-medium label mb-2">
                  Email Address
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                {errors.email && (
                  <p className="mt-1 text-sm text-white/80">{errors.email.message}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Password Field */}
              <div>
                <label htmlFor="password" className="block text-sm font-medium label mb-2">
                  Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                {errors.password && (
                  <p className="mt-1 text-sm text-white/80">{errors.password.message}</p>
                )}
              </div>

              {/* Confirm Password Field */}
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium label mb-2">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                {errors.confirmPassword && (
                  <p className="mt-1 text-sm text-white/80">{errors.confirmPassword.message}</p>
                )}
              </div>
            </div>
            ...
            {/* Bio Field */}
            <div>
              <label htmlFor="bio" className="block text-sm font-medium label mb-2">
                Bio (Optional)
              </label>
              <textarea
                {...register('bio')}
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium label mb-3">
                  Skills I Can Teach <span className="text-red-400">*</span>
                </label>
                <div className="relative">
                  <input
                    type="text"
                  ...
                  {activeSkillType === 'teach' && skillSearchTerm && (
              ...
              <div>
                <label className="block text-sm font-medium label mb-3">
                  Skills I Want to Learn <span className="text-red-400">*</span>
                </label>
                <div className="relative">
                  <input
                    type="text"
                  ...
                  {activeSkillType === 'learn' && skillSearchTerm && (
                    <div className="absolute z-10 mt-1 w-full card rounded-lg shadow-lg max-h-48 overflow-y-auto">
                      {filteredSkills.map((skill) => (
                        <button
                          key={skill}
            ...
            <div className="flex items-start space-x-3">
              ...
              />
              <label htmlFor="terms" className="text-sm label leading-relaxed">
                I agree to the{' '}
                <Link to="/terms" className="text-[var(--color-brand)] hover:text-white">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="/privacy" className="text-[var(--color-brand)] hover:text-white">
                  Privacy Policy
                </Link>
              </label>
            </div>
