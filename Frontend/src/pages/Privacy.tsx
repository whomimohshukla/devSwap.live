	...
	return (
		<div className='mx-auto max-w-3xl text-gray-200'>
			...
			<ul className='list-disc pl-6 text-sm text-gray-300 space-y-1'>
				<li>
					Session cookies (httpOnly) for secure authentication with the
					server
				</li>
				<li>
					Access token in local storage (only if you have accepted cookies)
				</li>
			...
			<ul className='list-disc pl-6 text-sm text-gray-300 space-y-1'>
				...
				<li>
					You can change your decision anytime by clearing site data in
					your browser
				</li>
			</ul>
			<p className='mt-6 text-sm text-gray-400'>
				For questions or requests related to your data, please contact
				support@devswap.live
			</p>
		</div>
	);
};
