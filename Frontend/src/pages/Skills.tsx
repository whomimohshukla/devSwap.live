...
const Skills: React.FC = () => {
	...
	const filteredSkills = getSkillsForCategory(selectedCategory).filter(
			...
			<div>
				...
				>
					...
					<p className='text-xl text-gray-400 max-w-2xl mx-auto'>
						Discover the technologies and frameworks you can learn or
						teach on DevSwap.live
					</p>
				</motion.div>
				...
				>
					...
					<p className='text-gray-400 mb-6 max-w-2xl mx-auto'>
						Join our community of developers and start exchanging skills
						today. Teach what you know, learn what you need.
					</p>
