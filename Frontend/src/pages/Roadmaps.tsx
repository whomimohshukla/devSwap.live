          ...
          {filtered.map((r) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="text-xl font-semibold mb-1 tracking-tight group-hover:text-teal-400">{r.title}</div>
              ...
              <div className="mt-4">
                <span className="inline-flex items-center gap-1 rounded-md bg-teal-600 px-3 py-1.5 text-sm font-medium text-black transition-colors group-hover:bg-teal-500">
                  ...
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path fillRule="evenodd" d="M3 10a.75.75 0 0 1 .75-.75h9.69L10.22 6.03a.75.75 0 1 1 1.06-1.06l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 1 1-1.06-1.06l3.22-3.22H3.75A.75.75 0 0 1 3 10Z" clipRule="evenodd" />
                  </svg>
                </span>
              </div>
            </Link>
